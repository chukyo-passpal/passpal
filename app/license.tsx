                ...
                <View style={{ padding: theme.spacing.lg }}>
                    <View style={{ marginBottom: theme.spacing.lg, alignItems: "center" }}>
                        <Typography variant="body" color={theme.colors.text.secondary}>
                            {currentPage} / {totalPages} ページ ({licenseEntries.length}
                            件中 {(currentPage - 1) * ITEMS_PER_PAGE + 1}-
                            {Math.min(currentPage * ITEMS_PER_PAGE, licenseEntries.length)}
                            件)
                        </Typography>
                    </View>
                    ...
                    >
                        <TouchableOpacity
                            ...
                            style={{
                                ...
                                backgroundColor:
                                    currentPage === 1 ? theme.colors.background.secondary : theme.colors.primary.main,
                                borderRadius: 8,
                                minWidth: 100,
                                alignItems: "center",
                            }}
                        >
                            <Typography
                                variant="body"
                                color={currentPage === 1 ? theme.colors.text.disabled : theme.colors.text.inverse}
                            >
                                前のページ
                            </Typography>
                        </TouchableOpacity>
                        ...
                        >
                            <Typography
                                variant="body"
                                color={
                                    currentPage === totalPages ? theme.colors.text.disabled : theme.colors.text.inverse
                                }
                            >
                                次のページ
                            </Typography>
