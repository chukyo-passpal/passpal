                ...
                {transportRoutes.map((route) => (
                    <Card key={route.id} style={{ marginBottom: theme.spacing.md }}>
                        <View style={{ marginBottom: theme.spacing.md }}>
                            ...
                            >
                                <View style={{ flex: 1 }}>
                                    <Typography variant="bodySmall" style={{ color: theme.colors.text.secondary }}>
                                        所要時間: {route.duration}
                                    </Typography>
                                    <Typography variant="bodySmall" style={{ color: theme.colors.text.secondary }}>
                                        運賃: {route.cost}
                        ...
                        <View style={{ marginTop: theme.spacing.md }}>
                            ...
                            {route.steps.map((step, index) => (
                                ...
                                >
                                    <Icon name={getTransportIcon(step.type) as any} size={16} color={theme.colors.primary.main} />
                                    <View style={{ marginLeft: theme.spacing.sm, flex: 1 }}>
                                        <Typography variant="bodySmall" style={{ color: theme.colors.text.primary }}>
                                            {step.description}
                                        </Typography>
                                        {step.cost && (
