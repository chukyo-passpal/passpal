    ...
    return (
        <ScrollView style={{ flex: 1 }} contentContainerStyle={{ padding: 20 }}>
            ...
            <View style={{ marginBottom: 32 }}>
                ...
                <TabNavigation tabs={tabs} onTabPress={(tabId: string) => setActiveTab(tabId)} />
            </View>
            ...
            <Card style={{ marginBottom: 24 }}>
                ...
                <CardContent>
                    <View style={{ gap: 16 }}>
                        <FeatureCard icon="home" title="Feature Card" description="Highlights important features and functionality" />

                        <InfoCard icon="calendar" title="Info Card" content="Displays informational content in a structured format" />
            ...
            <Card style={{ marginBottom: 24 }}>
                ...
                <CardContent>
                    <View style={{ gap: 16 }}>
                        <Input label="Email Address" placeholder="Enter your email" leftIcon={<Icon name="user" size={20} />} />
                ...
                <CardContent>
                    <View style={{ gap: 16 }}>
                        ...
                        <View>
                            ...
                            <View style={{ gap: 12 }}>
                                <Input label="Email" placeholder="Enter your email" leftIcon={<Icon name="user" size={20} />} />
                                <Input label="Password" placeholder="Enter your password" isPassword={true} />
                        ...
                        <View style={{ marginTop: 24 }}>
                            ...
                            <View style={{ gap: 12 }}>
                                <FeatureCard icon="clipboard-list" title="Assignments" description="3 pending assignments due this week" />
                                <InfoCard icon="calendar" title="Next Class" content="Mathematics - Room 101 at 2:00 PM" />
                            </View>
                        </View>
                    </View>
                </CardContent>
