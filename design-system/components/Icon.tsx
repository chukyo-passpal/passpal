...
export type IconName = 'home' | 'calendar' | 'user' | 'settings' | 'bell' | 'bus' | 'clipboard-list' | 
  'info' | 'palette' | 'cloud-upload' | 'log-out' | 'chevron-right' | 'train' | 'footprints' | 'map-pin';
...
export const BusIcon: React.FC<Omit<IconProps, 'name'>> = (props) => (
  <Icon name="bus" {...props} />
);

export const ClipboardIcon: React.FC<Omit<IconProps, 'name'>> = (props) => (
