...
import { Card, CardHeader, CardContent, CardDivider, FeatureCard, InfoCard, ThemeProvider, Typography, Icon } from "../index";
...
export const FeatureCardExample: Story = {
    render: () => <FeatureCard icon="home" title="Feature Title" description="This is a description of the feature card component." />,
    parameters: {
        docs: {
            description: {
...
export const InfoCardExample: Story = {
    render: () => <InfoCard icon="calendar" title="Information" content="This is content for the info card component." />,
    parameters: {
        docs: {
            description: {
...
export const ComplexCardLayout: Story = {
    render: () => (
        <Card variant="feature">
            ...
            <CardContent>
                <View style={{ gap: 12 }}>
                    <Typography variant="body">Complete the React Native assignment with proper component structure.</Typography>
...
export const CardShowcase: Story = {
    render: () => (
        <View style={{ gap: 16 }}>
            <FeatureCard icon="home" title="Dashboard" description="View your overview and statistics" />
            <InfoCard icon="calendar" title="Schedule" content="Check your upcoming events" />
