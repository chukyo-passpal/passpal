...
export const WithLeftIcon: Story = {
    render: () => <Input label="Search" placeholder="Search for something..." leftIcon={<Icon name="user" size={20} />} />,
    parameters: {
        docs: {
            description: {
...
export const WithRightIcon: Story = {
    render: () => <Input label="Location" placeholder="Enter location" rightIcon={<Icon name="map-pin" size={20} />} />,
    parameters: {
        docs: {
            description: {
...
const InteractiveInputComponent = () => {
    ...
    return <Input label="Interactive Input" placeholder="Type something..." value={value} onChangeText={setValue} />;
};
...
const InteractivePasswordComponent = () => {
    ...
    return <Input label="Password" placeholder="Enter your password" value={password} onChangeText={setPassword} isPassword={true} />;
};
...
const FormExampleComponent = () => {
    ...
    return (
        <View style={{ gap: 16 }}>
            ...
            />
            <Input label="Password" placeholder="Enter your password" value={password} onChangeText={setPassword} isPassword={true} />
        </View>
    );
};
